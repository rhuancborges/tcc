...
from lerInstancia import Request, Service
import matplotlib.pyplot as plt
from estruturas import Grafo, Sensor, FogNode, CloudNode
        ...
        while linha != "#end_requests":
            ...
            while (linha.split("_")[0] != "##time") and (linha != "#end_requests"):
                ...
                for destino, _ in candidatos:
                    ...
                    selecionado, processou, arcos, band, c, motivo = processar_caminho(caminho, Request(sensor, servicos[linha[2]]), dist)
